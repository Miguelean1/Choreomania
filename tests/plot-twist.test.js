...
test('lastMessage flag is set when at last message', () => {
...
test('isMessageSkipped flag can be set to true', () => {
    let isMessageSkipped = false;
    
    isMessageSkipped = true;
    
    expect(isMessageSkipped).toBe(true);
});
...
test('messageId can be incremented', () => {
    let messageId = 0;
...
test('messageId can be reset to 0', () => {
    let messageId = 5;
...
test('applytitlestyle flag is true by default', () => {
